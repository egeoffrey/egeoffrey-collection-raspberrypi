...
RUN apt-get update && apt-get install -y flac alsa-utils pocketsphinx sox pulseaudio mpg123 libttspico-utils bluetooth bluez bluez-tools pulseaudio-module-bluetooth rtl-sdr librtlsdr-dev && apt-get clean && rm -rf /var/lib/apt/lists/*
